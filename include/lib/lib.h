...
** Last update	Sun Apr 09 23:13:35 2017 Jordan Bonaldi
*/
...
int	my_printf(char *, ...);
char	**my_str_to_wordtab(char *, char c);
char	*get_next_line(int);
char	*get_next_line2(int);
char	*my_cut(size_t, char *);
char	*my_strcatc(char *, char);
char	**my_tabcat(char **, char **, int);
